...
class FetchDebtorInfoSignal(Signal):
    ...
    @staticmethod
    def get_routing_key(obj):  # pragma: no cover
        return calc_iri_routing_key(obj.iri)
...
class StoreDocumentSignal(Signal):
    ...
    @staticmethod
    def get_routing_key(obj):  # pragma: no cover
        return calc_iri_routing_key(obj.debtor_info_locator)
...
class DiscoverDebtorSignal(Signal):
    ...
    @staticmethod
    def get_routing_key(obj):  # pragma: no cover
        return calc_bin_routing_key(obj.debtor_id)
...
class TriggerTransferSignal(Signal):
    ...
    @staticmethod
    def get_routing_key(obj):  # pragma: no cover
        return calc_bin_routing_key(obj.collector_id)
...
class CalculateSurplusSignal(Signal):
    ...
    @classproperty
    def signalbus_burst_count(self):
        return current_app.config["APP_FLUSH_CALCULATE_SURPLUS_BURST_COUNT"]
