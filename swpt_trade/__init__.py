...
class Configuration(metaclass=MetaEnvReader):
    MIN_COLLECTOR_ID: _parse_creditor_id = (
    ...
    APP_PROCESS_PRISTINE_COLLECTORS_MAX_COUNT = 50000
    APP_PROCESS_PRISTINE_COLLECTORS_WAIT = 600.0
    ...
    APP_WORKER_SENDING_SLACK_DAYS = 150.0
    APP_WORKER_DISPATCHING_SLACK_DAYS = 180.0
    ...
    APP_WORKER_ACCOUNTS_SCAN_BLOCKS_PER_QUERY = 100
    APP_WORKER_ACCOUNTS_SCAN_BEAT_MILLISECS = 100
    APP_INTEREST_RATE_CHANGES_SCAN_DAYS = 7.0
    ...
    APP_DELAYED_ACCOUNT_TRANSFERS_SCAN_BLOCKS_PER_QUERY = 100
    ...
    APP_FLUSH_FETCH_DEBTOR_INFO_BURST_COUNT = 5000
    APP_FLUSH_STORE_DOCUMENT_BURST_COUNT = 5000
    APP_FLUSH_DISCOVER_DEBTOR_BURST_COUNT = 5000
    APP_FLUSH_CONFIRM_DEBTOR_BURST_COUNT = 5000
    APP_FLUSH_ACTIVATE_COLLECTOR_BURST_COUNT = 5000
    APP_FLUSH_CANDIDATE_OFFER_BURST_COUNT = 5000
    APP_FLUSH_NEEDED_COLLECTOR_BURST_COUNT = 5000
    APP_FLUSH_REVISE_ACCOUNT_LOCK_BURST_COUNT = 5000
    APP_FLUSH_TRIGGER_TRANSFER_BURST_COUNT = 5000
    APP_FLUSH_ACCOUNT_ID_REQUEST_BURST_COUNT = 5000
    APP_FLUSH_ACCOUNT_ID_RESPONSE_BURST_COUNT = 5000
    APP_FLUSH_START_SENDING_BURST_COUNT = 5000
    APP_FLUSH_START_DISPATCHING_BURST_COUNT = 5000
    APP_FLUSH_CALCULATE_SURPLUS_BURST_COUNT = 5000
    APP_FLUSH_REPLAYED_ACCOUNT_TRANSFERS_BURST_COUNT = 5000
