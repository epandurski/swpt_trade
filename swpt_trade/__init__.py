...
class Configuration(metaclass=MetaEnvReader):
    ...
    APP_DEBTOR_LOCATOR_CLAIMS_SCAN_BLOCKS_PER_QUERY = 30
    ...
    APP_RECENTLY_NEEDED_COLLECTORS_SCAN_BLOCKS_PER_QUERY = 30
    ...
    APP_FLUSH_FETCH_DEBTOR_INFO_BURST_COUNT = 7500
    APP_FLUSH_STORE_DOCUMENT_BURST_COUNT = 7500
    APP_FLUSH_DISCOVER_DEBTOR_BURST_COUNT = 7500
    APP_FLUSH_CONFIRM_DEBTOR_BURST_COUNT = 7500
    APP_FLUSH_ACTIVATE_COLLECTOR_BURST_COUNT = 7500
    APP_FLUSH_CANDIDATE_OFFER_BURST_COUNT = 7500
    APP_FLUSH_NEEDED_COLLECTOR_BURST_COUNT = 7500
    APP_FLUSH_REVISE_ACCOUNT_LOCK_BURST_COUNT = 7500
    APP_FLUSH_TRIGGER_TRANSFER_BURST_COUNT = 7500
    APP_FLUSH_ACCOUNT_ID_REQUEST_BURST_COUNT = 7500
    APP_FLUSH_ACCOUNT_ID_RESPONSE_BURST_COUNT = 7500
    APP_FLUSH_START_SENDING_BURST_COUNT = 7500
    APP_FLUSH_START_DISPATCHING_BURST_COUNT = 7500
    APP_FLUSH_CALCULATE_SURPLUS_BURST_COUNT = 7500
